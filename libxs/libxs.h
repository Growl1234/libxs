 ...
 */
 ...
 && !defined(LIBXS_CPUID_H) && !defined(LIBXS_GEMM_H) && !defined(LIBXS_HASH_H) \
 && !defined(LIBXS_HIST_H) && !defined(LIBXS_MALLOC_H) && !defined(LIBXS_MATH_H) \
 && !defined(LIBXS_MHD_H) && !defined(LIBXS_MEM_H) && !defined(LIBXS_NGRAM_H) \
 && !defined(LIBXS_PERM_H) && !defined(LIBXS_PREDICT_H) && !defined(LIBXS_REG_H) \
 && !defined(LIBXS_RNG_H)  && !defined(LIBXS_STR_H) && !defined(LIBXS_SYNC_H) \
 && !defined(LIBXS_TIMER_H) && !defined(LIBXS_TOKEN_H) && !defined(LIBXS_UTILS_H)
