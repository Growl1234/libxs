...
#   define LIBXS_API        LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_VISIBILITY_IMPORT LIBXS_RETARGETABLE
#   define LIBXS_API_INTERN LIBXS_EXTERN_C LIBXS_VISIBILITY_PRIVATE LIBXS_RETARGETABLE
...
#   define LIBXS_API_INTERN LIBXS_EXTERN_C LIBXS_VISIBILITY_PRIVATE LIBXS_RETARGETABLE
#   define LIBXS_API_EXPORT LIBXS_API
#   define LIBXS_APIEXT LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_VISIBILITY_IMPORT LIBXS_RETARGETABLE
# else /* import */
#   define LIBXS_API        LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_VISIBILITY_IMPORT LIBXS_RETARGETABLE
#   define LIBXS_API_INTERN LIBXS_API
#   define LIBXS_API_EXPORT LIBXS_API
...
# endif
# define LIBXS_APIVAR(DECL) LIBXS_API_INTERN DECL; LIBXS_API_INTERN DECL
