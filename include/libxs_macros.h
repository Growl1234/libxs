...
# define LIBXS_APIVAR_DEFINE(DECL) /* elide */
#else /* classic ABI */
# if defined(LIBXS_BUILD_EXT)
#   define LIBXS_API        LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_API_INTERN LIBXS_EXTERN_C                        LIBXS_RETARGETABLE LIBXS_VISIBILITY_PRIVATE
#   define LIBXS_API_EXPORT LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_APIEXT     LIBXS_EXTERN_C                        LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT
#   define LIBXS_APIEXT_INTERN LIBXS_API_INTERN
# elif defined(LIBXS_BUILD)
#   define LIBXS_API        LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT
#   define LIBXS_API_INTERN LIBXS_EXTERN_C                        LIBXS_RETARGETABLE LIBXS_VISIBILITY_PRIVATE
#   define LIBXS_API_EXPORT LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT
#   define LIBXS_APIEXT     LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
# else /* import */
#   define LIBXS_API        LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_API_INTERN LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_API_EXPORT LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_APIEXT     LIBXS_EXTERN_C LIBXS_EXTERN_KEYWORD LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
# endif
# define LIBXS_APIVAR_DEFINE(DECL) LIBXS_ALIGNED(LIBXS_EXTERN_C LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT DECL, LIBXS_CONFIG_CACHELINE);
# define LIBXS_APIVAR_PUBLIC(DECL) LIBXS_API DECL
# define LIBXS_APIVAR(DECL) LIBXS_API_INTERN DECL
#endif
#if !defined(_WIN32)
