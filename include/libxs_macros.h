...
#endif
#if !defined(_WIN32)
# define LIBXS_APIVAR_PRIVATE(DECL) LIBXS_APIVAR(LIBXS_ALIGNED(DECL, LIBXS_CONFIG_CACHELINE))
# define LIBXS_APIVAR_ALIGNED(DECL) LIBXS_APIVAR_PUBLIC(LIBXS_ALIGNED(DECL, LIBXS_CONFIG_CACHELINE))
# define LIBXS_APIVAR_ARRAY(DECL, N) LIBXS_APIVAR(LIBXS_ALIGNED(DECL[N], LIBXS_CONFIG_CACHELINE))
#else /* Windows */
# define LIBXS_APIVAR_PRIVATE(DECL) LIBXS_APIVAR(DECL)
# define LIBXS_APIVAR_ALIGNED(DECL) LIBXS_APIVAR_PUBLIC(DECL)
# define LIBXS_APIVAR_ARRAY(DECL, N) LIBXS_APIVAR(DECL[N])
#endif
...
# define LIBXS_VLA_ACCESS_NONCONST(I, S) (libxs_vla_dummy_[I] = (S))
...
# define LIBXS_VLA_ACCESS_1D(ARRAY, XY, ...) ((ARRAY)[LIBXS_VLA_ACCESS_NONCONST(0, LIBXS_SELECT_HEAD(__VA_ARGS__))])
# define LIBXS_VLA_ACCESS_2D(ARRAY, XY, I0, I1, ...) (((ARRAY) XY(__VA_ARGS__))[I0][LIBXS_VLA_ACCESS_NONCONST(1, I1)])
# define LIBXS_VLA_ACCESS_3D(ARRAY, XY, I0, I1, I2, S1, ...) (((ARRAY) XY(S1) XY(__VA_ARGS__))[I0][I1][LIBXS_VLA_ACCESS_NONCONST(2, I2)])
# define LIBXS_VLA_ACCESS_4D(ARRAY, XY, I0, I1, I2, I3, S1, S2, ...) (((ARRAY) XY(S1) XY(S2) XY(__VA_ARGS__))[I0][I1][I2][LIBXS_VLA_ACCESS_NONCONST(3, I3)])
# define LIBXS_VLA_ACCESS_5D(ARRAY, XY, I0, I1, I2, I3, I4, S1, S2, S3, ...) (((ARRAY) XY(S1) XY(S2) XY(S3) XY(__VA_ARGS__))[I0][I1][I2][I3][LIBXS_VLA_ACCESS_NONCONST(4, I4)])
# define LIBXS_VLA_ACCESS_6D(ARRAY, XY, I0, I1, I2, I3, I4, I5, S1, S2, S3, S4, ...) (((ARRAY) XY(S1) XY(S2) XY(S3) XY(S4) XY(__VA_ARGS__))[I0][I1][I2][I3][I4][LIBXS_VLA_ACCESS_NONCONST(5, I5)])
# define LIBXS_VLA_ACCESS_7D(ARRAY, XY, I0, I1, I2, I3, I4, I5, I6, S1, S2, S3, S4, S5, ...) (((ARRAY) XY(S1) XY(S2) XY(S3) XY(S4) XY(S5) XY(__VA_ARGS__))[I0][I1][I2][I3][I4][I5][LIBXS_VLA_ACCESS_NONCONST(6, I6)])
# define LIBXS_VLA_ACCESS_8D(ARRAY, XY, I0, I1, I2, I3, I4, I5, I6, I7, S1, S2, S3, S4, S5, S6, ...) (((ARRAY) XY(S1) XY(S2) XY(S3) XY(S4) XY(S5) XY(S6) XY(__VA_ARGS__))[I0][I1][I2][I3][I4][I5][I6][LIBXS_VLA_ACCESS_NONCONST(7, I7)])
# define LIBXS_VLA_DECL(NDIMS, ELEMENT_TYPE, ARRAY_VAR, .../*initial value, and bounds*/) \
    ELEMENT_TYPE LIBXS_VLA_ACCESS_ND(LIBXS_SELECT_ELEMENT(NDIMS, 0, 1, 2, 3, 4, 5, 6, 7), *LIBXS_RESTRICT LIBXS_CONCATENATE(ARRAY_VAR, LIBXS_VLA_POSTFIX), \
      LIBXS_ELIDE, LIBXS_SELECT_TAIL(__VA_ARGS__, 0)/*bounds*/, LIBXS_SELECT_TAIL(__VA_ARGS__, 0)/*dummy*/) = \
   (ELEMENT_TYPE LIBXS_VLA_ACCESS_ND(LIBXS_SELECT_ELEMENT(NDIMS, 0, 1, 2, 3, 4, 5, 6, 7), *, \
