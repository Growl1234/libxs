...
#   define LIBXS_API        LIBXS_EXTERN   LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_API_INTERN LIBXS_EXTERN_C LIBXS_RETARGETABLE LIBXS_VISIBILITY_PRIVATE
#   define LIBXS_API_EXPORT LIBXS_EXTERN   LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_APIEXT     LIBXS_EXTERN_C LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT
#   define LIBXS_APIEXT_INTERN LIBXS_API_INTERN
# elif defined(LIBXS_BUILD)
#   define LIBXS_API        LIBXS_EXTERN   LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT
#   define LIBXS_API_INTERN LIBXS_EXTERN_C LIBXS_RETARGETABLE LIBXS_VISIBILITY_PRIVATE
#   define LIBXS_API_EXPORT LIBXS_EXTERN   LIBXS_RETARGETABLE LIBXS_VISIBILITY_EXPORT
#   define LIBXS_APIEXT     LIBXS_EXTERN   LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
# else /* import */
#   define LIBXS_API        LIBXS_EXTERN LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_API_INTERN LIBXS_EXTERN LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_API_EXPORT LIBXS_EXTERN LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
#   define LIBXS_APIEXT     LIBXS_EXTERN LIBXS_RETARGETABLE LIBXS_VISIBILITY_IMPORT
# endif
