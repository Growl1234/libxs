...
# define LIBXS_CHECK_LONG(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, LONG_MIN, LONG_MAX), "Value cannot be represented as LONG")
# define LIBXS_CHECK_USHORT(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, 0, USHRT_MAX), "Value cannot be represented as USHORT")
# define LIBXS_CHECK_SHORT(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, SHRT_MIN, SHRT_MAX), "Value cannot be represented as SHORT")
# define LIBXS_CHECK_UCHAR(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, 0, UCHAR_MAX), "Value cannot be represented as UCHAR")
# define LIBXS_CHECK_ICHAR(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, SCHAR_MIN, SCHAR_MAX), "Value cannot be represented as ICHAR")
# define LIBXS_CHECK_UINT(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, 0, UINT_MAX), "Value cannot be represented as UINT")
# define LIBXS_CHECK_INT(VALUE) LIBXS_ASSERT_MSG(LIBXS_CHECK_VALUE(VALUE, INT_MIN, INT_MAX), "Value cannot be represented as INT")
