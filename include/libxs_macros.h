...
#define LIBXS_APIVAR(DECL, VISIBILITY, EXTERN) EXTERN LIBXS_RETARGETABLE LIBXS_API_VISIBILITY(VISIBILITY) DECL
#define LIBXS_API_INLINE LIBXS_INLINE LIBXS_RETARGETABLE
#define LIBXS_API_NONE
...
#define LIBXS_APIVAR_PUBLIC_DEF(DECL) LIBXS_ALIGNED(LIBXS_APIVAR(DECL, EXPORT, LIBXS_API_NONE), LIBXS_CONFIG_CACHELINE)
