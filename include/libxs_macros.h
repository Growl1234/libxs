...
#define LIBXS_MAX_EQN_COUNT LIBXS_CONFIG_MAX_EQN_COUNT
...
#else
# define LIBXS_BLAS_SYMBOL_FDECL(TYPE, KIND)
# define LIBXS_BLAS_SYMBOL_CDECL(TYPE, KIND)
#endif
...
#define LIBXS_WIDEN_U32U64(VALUE) libxs_widen_u32u64(LIBXS_CAST_UINT(VALUE))
