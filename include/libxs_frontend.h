...
# define LIBXS_GEMM_SYMBOL_VISIBILITY LIBXS_EXTERN_KEYWORD LIBXS_VISIBILITY_IMPORT LIBXS_RETARGETABLE
#endif
...
#define LIBXS_BLAS_SYMBOL_FDECL(CONST_STAR, STAR, TYPE, KIND) LIBXS_GEMM_SYMBOL_VISIBILITY \
