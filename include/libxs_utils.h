...
# define LIBXS_INTRINSICS_MM512_CVTU32_MASK LIBXS_CONCATENATE(LIBXS_INTRINSICS_MM512_CVTU32_MASK_, NBITS)
# define LIBXS_INTRINSICS_MM512_CVTU32_MASK_32(A, NBITS) ((__mmask32)(A))
# define LIBXS_INTRINSICS_MM512_CVTU32_MASK_16(A, NBITS) _mm512_int2mask((int)(A))
# define LIBXS_INTRINSICS_MM512_CVTU32_MASK_8(A, NBITS) ((__mmask8)(A))
#else
# define LIBXS_INTRINSICS_MM512_STORE_MASK(DST_PTR, SRC) \
    (*(LIBXS_CONCATENATE(__mmask, NBITS)*)(DST_PTR) = (LIBXS_CONCATENATE(__mmask, NBITS))(SRC))
