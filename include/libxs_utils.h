...
#if defined(LIBXS_X86_AVX512_CPX) /*__AVX512BF16__*/
# define LIBXS_INTRINSISCS_MM512_CVTNEPS_PBH( A ) _mm512_cvtneps_pbh( A )
# define LIBXS_INTRINSISCS_MM512_CVTNE2PS_PBH( A, B ) _mm512_cvtne2ps_pbh( A, B )
#else
# define LIBXS_INTRINSISCS_MM512_CVTNEPS_PBH( A ) LIBXS_INTRINSICS_MM512_CVT_FP32_BF16( A )
# define LIBXS_INTRINSISCS_MM512_CVTNE2PS_PBH( A, B ) LIBXS_INTRINSICS_MM512_CVT2_FP32_BF16( A, B )
#endif
