...
LIBXS_APIVAR_PRIVATE(unsigned int libxs_intrinsics_mm512_rng_state0[16]);
LIBXS_APIVAR_PRIVATE(unsigned int libxs_intrinsics_mm512_rng_state1[16]);
LIBXS_APIVAR_PRIVATE(unsigned int libxs_intrinsics_mm512_rng_state2[16]);
LIBXS_APIVAR_PRIVATE(unsigned int libxs_intrinsics_mm512_rng_state3[16]);
