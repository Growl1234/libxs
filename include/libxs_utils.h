...
# define LIBXS_INTRINSISCS_MM512_CVTNEPS_PBH( A ) (__m512i)_mm512_cvtneps_pbh( A )
# define LIBXS_INTRINSISCS_MM512_CVTNE2PS_PBH( A, B ) (__m512i)_mm512_cvtne2ps_pbh( A, B )
#else
