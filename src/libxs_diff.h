...
# define LIBXS_DIFF_64_LOAD(A, SRC) LIBXS_DIFF_32_LOAD(A, SRC); LIBXS_DIFF_32_LOAD(LIBXS_CONCATENATE3(libxs_diff_64_, A, _), (const uint64_t*)(SRC) + 4)
# define LIBXS_DIFF_64(A, B, ...) ((unsigned char)(0 != LIBXS_DIFF_32(A, B, __VA_ARGS__) ? 1 : LIBXS_DIFF_32(LIBXS_CONCATENATE3(libxs_diff_64_, A, _), (const uint64_t*)(B) + 4, __VA_ARGS__)))
#endif
