...
LIBXS_API_INTERN libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_bf16_bf16_amx_emu(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid);
...
LIBXS_API_INLINE LIBXS_INTRINSICS(LIBXS_X86_AVX512_CORE)
void bf16_transpose_32x16(libxs_bfloat16 *in, libxs_bfloat16 *out, int ld_in, int ld_out)
{
#if defined(LIBXS_INTRINSICS_AVX512_CORE)
  ...
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 0*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t0, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 1*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t0, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 2*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t1, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 3*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t1, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 4*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t2, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 5*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t2, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 6*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t3, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 7*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t3, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 8*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t4, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 9*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t4, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 10*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t5, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 11*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t5, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 12*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t6, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 13*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t6, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 14*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t7, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 15*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t7, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 16*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t8, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 17*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t8, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 18*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t9, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 19*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t9, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 20*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(ta, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 21*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(ta, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 22*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tb, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 23*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tb, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 24*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tc, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 25*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tc, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 26*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(td, 0));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 27*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(td, 1));
  LIBXS_INTRINSICS_MM256_STORE_EPI32(out + 28*out_width, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(te, 0));
...
LIBXS_API_INLINE LIBXS_INTRINSICS(LIBXS_X86_AVX512_CORE)
void bf16_transpose_32xcols(libxs_bfloat16 *in, libxs_bfloat16 *out, int col, int ld_in, int ld_out)
{
#if defined(LIBXS_INTRINSICS_AVX512_CORE)
  __m512i r0 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r1 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r2 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r3 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r4 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r5 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r6 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r7 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r8 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), r9 = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), ra = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), rb = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), rc = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), rd = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), re = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32(), rf = LIBXS_INTRINSICS_MM512_UNDEFINED_EPI32();
  __m512i t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, ta, tb, tc, td, te, tf;
  const int in_width=ld_in, out_width=ld_out;
  const __m512i idx_lo         = _mm512_set_epi64(13, 12, 5, 4, 9, 8, 1, 0);
  const __m512i idx_hi         = _mm512_set_epi64(7, 6, 15, 14, 3, 2, 11, 10);
  ...
  _mm256_mask_storeu_epi16(out + 0*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t0, 0));
  _mm256_mask_storeu_epi16(out + 1*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t0, 1));
  _mm256_mask_storeu_epi16(out + 2*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t1, 0));
  _mm256_mask_storeu_epi16(out + 3*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t1, 1));
  _mm256_mask_storeu_epi16(out + 4*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t2, 0));
  _mm256_mask_storeu_epi16(out + 5*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t2, 1));
  _mm256_mask_storeu_epi16(out + 6*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t3, 0));
  _mm256_mask_storeu_epi16(out + 7*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t3, 1));
  _mm256_mask_storeu_epi16(out + 8*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t4, 0));
  _mm256_mask_storeu_epi16(out + 9*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t4, 1));
  _mm256_mask_storeu_epi16(out + 10*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t5, 0));
  _mm256_mask_storeu_epi16(out + 11*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t5, 1));
  _mm256_mask_storeu_epi16(out + 12*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t6, 0));
  _mm256_mask_storeu_epi16(out + 13*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t6, 1));
  _mm256_mask_storeu_epi16(out + 14*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t7, 0));
  _mm256_mask_storeu_epi16(out + 15*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t7, 1));
  _mm256_mask_storeu_epi16(out + 16*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t8, 0));
  _mm256_mask_storeu_epi16(out + 17*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t8, 1));
  _mm256_mask_storeu_epi16(out + 18*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t9, 0));
  _mm256_mask_storeu_epi16(out + 19*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(t9, 1));
  _mm256_mask_storeu_epi16(out + 20*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(ta, 0));
  _mm256_mask_storeu_epi16(out + 21*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(ta, 1));
  _mm256_mask_storeu_epi16(out + 22*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tb, 0));
  _mm256_mask_storeu_epi16(out + 23*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tb, 1));
  _mm256_mask_storeu_epi16(out + 24*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tc, 0));
  _mm256_mask_storeu_epi16(out + 25*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(tc, 1));
  _mm256_mask_storeu_epi16(out + 26*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(td, 0));
  _mm256_mask_storeu_epi16(out + 27*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(td, 1));
  _mm256_mask_storeu_epi16(out + 28*out_width, store_mask, LIBXS_INTRINSICS_MM512_EXTRACTI64X4_EPI64(te, 0));
...
LIBXS_API_INLINE LIBXS_INTRINSICS(LIBXS_X86_AVX512_CORE)
void bf16_transpose(libxs_bfloat16 *in, libxs_bfloat16 *out, int M, int N, int ld_in, int ld_out){
#if defined(LIBXS_INTRINSICS_AVX512_CORE)
  int i, j;
  ...
  if (full16_chunks) {
    for (i=0; i<M; i+=32) {
      for (j=0; j<_N; j+=16) {
        bf16_transpose_32x16((libxs_bfloat16*)in + i + ld_in*j, (libxs_bfloat16*)out + j + i*ld_out, ld_in, ld_out);
      }
    }
  }
  ...
  if (remainder_cols) {
    for (i=0; i<M; i+=32) {
      bf16_transpose_32xcols((libxs_bfloat16*)in + i + ld_in*full16_chunks*16, (libxs_bfloat16*)out + full16_chunks*16 + i*ld_out, remainder_cols, ld_in, ld_out);
    }
  }
#else
 LIBXS_UNUSED(in); LIBXS_UNUSED(out); LIBXS_UNUSED(M); LIBXS_UNUSED(N); LIBXS_UNUSED(ld_in); LIBXS_UNUSED(ld_out);
#endif
}

LIBXS_API_INLINE LIBXS_INTRINSICS(LIBXS_X86_AVX512_CORE)
void bf16_vnni_reformat(libxs_bfloat16 *_in, libxs_bfloat16 *_out, int M, int N, int ld_in, int ld_out) {
#if defined(LIBXS_INTRINSICS_AVX512_CORE)
  int n_full_pairs = N/2, n_pair, m;
  int half_n_pair = N%2;
  libxs_bfloat16 *in = _in, *out = _out;
  const __m512i selector = LIBXS_INTRINSICS_MM512_SET_EPI16(32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0, 32, 0);
  const __m512i offsets_lo = LIBXS_INTRINSICS_MM512_SET_EPI16(15, 15, 14, 14, 13, 13, 12, 12, 11, 11, 10, 10, 9, 9, 8, 8, 7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1, 0, 0);
  const __m512i offsets_hi = LIBXS_INTRINSICS_MM512_SET_EPI16(31, 31, 30, 30, 29, 29, 28, 28, 27, 27, 26, 26, 25, 25, 24, 24, 23, 23, 22, 22, 21, 21, 20, 20, 19, 19, 18, 18, 17, 17, 16, 16);
  ...
  for (n_pair = 0; n_pair < n_full_pairs; n_pair++) {
    for (m = 0; m < M; m+=32) {
      n0 = _mm512_loadu_si512((const libxs_bfloat16*)in+m);
      n1 = _mm512_loadu_si512((const libxs_bfloat16*)in+m+ld_in);
...
libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_custom_f32_f32(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  ...
  libxs_blasint lda_bwd = (libxs_blasint)handle->ifmblock;
  libxs_blasint ldb_bwd = (libxs_blasint)handle->desc.K;
  libxs_blasint ldc_bwd = (libxs_blasint)handle->desc.C;
  ...
  if ( handle->desc.fuse_ops == LIBXS_DNN_FULLYCONNECTED_FUSE_NONE ) {
    ...
    gemm_function gemm_kernel_bwd = libxs_smmdispatch(handle->ifmblock, handle->desc.N, handle->desc.K, &lda_bwd, &ldb_bwd, &ldc_bwd, &alpha, &beta, NULL, NULL);
    gemm_function gemm_kernel_upd = libxs_smmdispatch(handle->ofmblock, handle->ifmblock, handle->desc.N, &lda_upd, &ldb_upd, &ldc_upd, &alpha, &beta, NULL, NULL);
# include "template/libxs_dnn_fullyconnected_st_bwdupd_custom_generic.tpl.c"
  } else {
...
LIBXS_API_INTERN LIBXS_INTRINSICS(LIBXS_X86_AVX512)
libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_custom_bf16_f32(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  libxs_dnn_err_t status = LIBXS_DNN_SUCCESS;
#if defined(LIBXS_INTRINSICS_AVX512) /*__AVX512F__*/
...
LIBXS_API_INTERN LIBXS_INTRINSICS(LIBXS_X86_AVX512)
libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_f32_f32(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  libxs_dnn_err_t status = LIBXS_DNN_SUCCESS;
#if defined(LIBXS_INTRINSICS_AVX512) /*__AVX512F__*/
  typedef float element_input_type;
...
libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_bf16_bf16_emu(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  libxs_dnn_err_t status = LIBXS_DNN_SUCCESS;
...
libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_bf16_bf16_amx(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  return libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_bf16_bf16_amx_emu(handle, kind, start_thread, tid);
}
#endif

LIBXS_API_INTERN LIBXS_INTRINSICS(LIBXS_X86_AVX512_CORE)
libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_bf16_bf16_amx_emu(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  libxs_dnn_err_t status = LIBXS_DNN_SUCCESS;
#if defined(LIBXS_INTRINSICS_AVX512_CORE) /*__AVX512F__,__AVX512BW__,__AVX512DQ__*/
  typedef libxs_bfloat16 element_input_type;
...
LIBXS_API_INTERN libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_custom(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  ...
  if ( handle->target_archid >= LIBXS_X86_AVX512 ) {
    if (handle->desc.datatype_in == LIBXS_DNN_DATATYPE_F32 && handle->desc.datatype_out == LIBXS_DNN_DATATYPE_F32 ) {
      status = libxs_dnn_fullyconnected_st_bwdupd_custom_f32_f32( handle, kind, start_thread, tid);
    }
      ...
      status = libxs_dnn_fullyconnected_st_bwdupd_custom_bf16_f32( handle, kind, start_thread, tid);
    }
#endif
    else {
...
LIBXS_API_INTERN libxs_dnn_err_t libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck(libxs_dnn_fullyconnected* handle, libxs_dnn_compute_kind kind, int start_thread, int tid)
{
  ...
  if ( ((handle->desc.fuse_ops & LIBXS_DNN_FULLYCONNECTED_FUSE_BIAS ) != 0) && ( handle->grad_bias == 0 ) )  {
    status = LIBXS_DNN_ERR_DATA_NOT_BOUND;
    return status;
  }
  ...
  if ( handle->target_archid >= LIBXS_X86_AVX512 ) {
    if (handle->desc.datatype_in == LIBXS_DNN_DATATYPE_F32 && handle->desc.datatype_out == LIBXS_DNN_DATATYPE_F32 ) {
      status = libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_f32_f32( handle, kind, start_thread, tid);
    }
#if defined(LIBXS_INTRINSICS_AVX512_CPX) /*__AVX512F__,__AVX512BW__,__AVX512DQ__,__AVX512BF16__*/
      ...
      if ( l_emu_amx == 0 ) {
        ...
        status = libxs_dnn_fullyconnected_st_bwdupd_ncnc_kcck_bf16_bf16_amx_emu( handle, kind, start_thread, tid);
      }
    }
